...
# The SECRET_KEY is created automatically when you run the startproject command. 
# You can store it by creating  a file called ".env" in your workspace, 
# and adding SECRET_KEY='$generated_secret_key'.  
